...
<div class="TopRightCorner"> 
	...
	<div class = "CenteredPannel">
        ...
        <?php
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<form class ="studentWorkContainer" action="detailed_student_work.php" method="post">
                        ...
                        if($role == "Teacher")
                        {
                            echo'<button type="submit" class="visitButton" name="edit" id="edit" style="     margin-right: -37.8%;">Edit</button>';
                        }
            ...
            if($role=="Student")
            {
                echo '<a href="file_uploader/upload_page.php">
                <div class="float_add_or_check"><b>+</b></div>
                </a>';
            }else
            if($role=="Teacher")
            {
                echo '<a href="waiting_list.php">
                <div class="float_add_or_check"><b>&#x2713;</b></div>
                </a>';
            }
            echo '
