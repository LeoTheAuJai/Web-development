...
<div class = "CenteredPannel">
    ...
    <?php
        ...
        if(isset($_POST["edit"])){
            ...
            echo '<form id="updateForm" action="updating.php" method="POST" enctype="multipart/form-data"style="left: 50px;width:850px; height:70%;  text-align: center;">
                                    <input type="hidden" name="student_work_id" value="'.$student_work_id.'">
            ...
            <div class="old_data_frame">
                <input type="String" name="Title" id="Title" value="'.$title.'" placeholder = "Title"style="padding-left: 10px;float:left;border-radius: 50px ;font-size: 35px;width: 510px;height: 50px;">
...
//$conn->close();
                echo'<textarea name="Description" id="Description"placeholder = "Type some description to describe your work in under 200 characters."style="padding: 7px;float:left;border-radius: 20px ; margin-top:10px;width: 510px;height:220px; " rows="2" cols="50">
'.$description.'</textarea>
      ...
      <div class="mb-3">
        <label for="file" class="form-label">Last Selected File: '.$path_file.'</label>
        <input type="file" class="form-control" name="zipFile" id = "zipFile" accept=".zip" required style="border:solid,2px;border-radius:5px;width:96%;margin-top:20px;">
                    ...
                    <button type="submit" class="submitFrame" name="edit">
                        <header style="padding:10px;">EDIT THE STUDENT WORK</header>
                    </button>
                    <button type="submit" class="submitFrame-red" name="delete">
                        <header style="padding:10px;">DELETE THE STUDENT WORK</header>
                    </button>
            </form>';
        }
